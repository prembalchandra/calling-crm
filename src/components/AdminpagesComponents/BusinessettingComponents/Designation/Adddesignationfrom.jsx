        ...
        <div className="addvideo-from">
            ...
            <form onSubmit={handleSubmit} className='add-form-box'>
                ...
                <div className='employee-search-area-box mb-3'>
                    ...
                    <input type="text" className='input-size form-control-search' name="designation_name" value={formData.designation_name} onChange={handleChange} required />
                </div>
