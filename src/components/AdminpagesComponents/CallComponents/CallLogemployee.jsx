...
function TodayAssigndata() {
    const [filters, setFilters] = useState({ searchText: '', product: '' ,Date :'' });
    ...
    const handleReset = () => {
        setFilters({ searchText: '', product: '',Date:''});
        setCurrentPage(1);
    };
    ...
    return (
        <section className='main-content-area'>
            <Breadcrumb
                title="View Call Log Employee"
                titleIcon="bx bx-phone-call"
                buttons={[
                    {
                        label: (
                    ...
                    {
                        label: <>Total Call Log Employee: <span className="badge-length">{filteredEmployees.length}</span></>,
                        className: "btn-bg-2",
                    },
                    {
                ...
                <div className="row align-items-center filterformpay flex-wrap">
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-6 col-12 mb-1">
                        <div className='employee-search-area-box'>
                            ...
                            <input className="input-size form-control-search"   type="date" name="date" value={filters.date} onChange={handleInputChange}/>
                        </div>
                    </div>
                     <div className="col-lg-3 col-md-3 col-sm-6 col-12 mb-1">
